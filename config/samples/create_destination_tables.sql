...
CREATE TABLE sandbox.app_base (
	...
	app_type_enum					smallint		NULL	 CONSTRAINT FK_app_base_app_type_enum__app_enums_enum_id FOREIGN KEY REFERENCES sandbox.app_enums(enum_id) ON DELETE NO ACTION,
	booked_date						datetime		NULL,
	decision_enum					smallint		NULL	 CONSTRAINT FK_app_base_decision_enum__app_enums_enum_id FOREIGN KEY REFERENCES sandbox.app_enums(enum_id) ON DELETE NO ACTION,
...
CREATE TABLE sandbox.app_operational_cc (
	...
	priority_enum					smallint		NULL	 CONSTRAINT FK_app_operational_cc_priority_enum__app_enums_enum_id FOREIGN KEY REFERENCES sandbox.app_enums(enum_id) ON DELETE NO ACTION,
	process_enum					smallint		NULL	 CONSTRAINT FK_app_operational_cc_process_enum__app_enums_enum_id FOREIGN KEY REFERENCES sandbox.app_enums(enum_id) ON DELETE NO ACTION,
	...
	sc_bank_account_type_enum		smallint		NULL	 CONSTRAINT FK_app_operational_cc_sc_bank_account_type_enum__app_enums_enum_id FOREIGN KEY REFERENCES sandbox.app_enums(enum_id) ON DELETE NO ACTION,	
	sc_debit_funding_source_enum	smallint		NULL	 CONSTRAINT FK_app_operational_cc_sc_debit_funding_source_enum__app_enums_enum_id FOREIGN KEY REFERENCES sandbox.app_enums(enum_id) ON DELETE NO ACTION,
	...
	ssn_match_type_enum				smallint		NULL	 CONSTRAINT FK_app_operational_cc_ssn_match_type_enum__app_enums_enum_id FOREIGN KEY REFERENCES sandbox.app_enums(enum_id) ON DELETE NO ACTION,
	status_enum						smallint		NULL	 CONSTRAINT FK_app_operational_cc_status_enum__app_enums_enum_id FOREIGN KEY REFERENCES sandbox.app_enums(enum_id) ON DELETE NO ACTION,
	verification_source_enum		smallint		NULL	 CONSTRAINT FK_app_operational_cc_verification_source_enum__app_enums_enum_id FOREIGN KEY REFERENCES sandbox.app_enums(enum_id) ON DELETE NO ACTION,

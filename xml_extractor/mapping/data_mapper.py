...
class DataMapper(DataMapperInterface):
    ...
    def _apply_enum_mapping(self, value: Any, mapping: FieldMapping) -> int:
        ...
        # If no valid mapping, exclude column from INSERT to maintain data integrity
        return None
    ...
    def _transform_to_string(self, value: Any, max_length: Optional[int] = None) -> str:
        """Transform value to string with optional length limit."""
        if value is None:
            return None
        try:
    ...
    def _get_fallback_value(self, value: Any, target_type: str) -> Any:
        """Get fallback value for failed transformations."""
        # Return None to exclude from INSERT (following mapping principles)
        return None
    
    def _get_fallback_for_mapping(self, mapping: FieldMapping, error: Exception) -> Any:
        """Get fallback value for failed mapping application."""
        # Return None to exclude from INSERT (following mapping principles)
        return None
    
    def _get_default_for_mapping(self, mapping: FieldMapping) -> Any:
        """Get default value for mapping when no value is found."""
        # Return None to exclude from INSERT (following mapping principles)
        return None
    
    def _transform_to_datetime(self, value: Any, target_type: str) -> Any:
        ...
        try:
            ...
            if isinstance(value, str):
                ...
                for fmt in ['%m/%d/%Y', '%Y-%m-%d %H:%M:%S.%f', '%Y-%m-%d %H:%M:%S', '%Y-%m-%d']:
                    try:
    ...
    def _transform_to_decimal(self, value: Any, target_type: str) -> Any:
